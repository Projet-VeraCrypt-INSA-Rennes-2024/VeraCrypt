...
namespace VeraCrypt
{
	...
	{
		PasswordPanel = new VolumePasswordPanel (this, NULL, password, keyfiles, false, true, true, enableConfirmation, !enableConfirmation, !enableConfirmation, wxString(), SecurityTokenKeyfilesDialog::KeyDisplay::PublicKeysOnly);
